...
function Mainholder:Window(hubname, gamename)
   ...
   switchFrame.Parent = ContainerHold
   switchFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
   -- switchFrame.Position = UDim2.new(0.292307705, 0, 0, 0)
   switchFrame.Size = UDim2.new(0, 650, 0, 0)
   switchFrame.ZIndex = 99
   switchFrame.Visible = false

   switchFrameCorner.CornerRadius = UDim.new(0, 5)
   switchFrameCorner.Name = "switchFrameCorner"
...
function Tabs:Tab(Title)
   ...
   Tab.MouseButton1Click:Connect(
         function()
            ...
            --    switchFrame,
            --    TweenInfo.new(.5, Enum.EasingStyle.Quad),
            --    {Position = UDim2.new(0.292307705, 0, 0.965770245, 0)}
            -- ):Play()
            repeat wait() until switchFrame.Size == UDim2.new(0, 650, 0, 410)


            -- switchFrame.Name = "switchFrame"
            -- switchFrame.Parent = game.StarterGui.woof.MainFrame.ContainerHold
            -- switchFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            -- switchFrame.Position = UDim2.new(0.292307705, 0, 0, 0)
            -- switchFrame.Size = UDim2.new(0, 457, 0, 0)
            -- switchFrame.ZIndex = 99
            ...
            --    switchFrame,
            --    TweenInfo.new(.5, Enum.EasingStyle.Quad),
            --    {Position = UDim2.new(0.292307705, 0, 0, 0)}
            -- ):Play()
            repeat task.wait() until switchFrame.Size == UDim2.new(0, 650, 0, 0)
            switchFrame.Visible = false
         end)
